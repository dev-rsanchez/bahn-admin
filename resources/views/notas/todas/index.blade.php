            ...
            @foreach ($notas as $nota)
                ...
                <div class="card border-primary mb-3" style="max-width: 18rem;">
                    <div class="card-header"><b>{{$nota->titulo}}</b>
                        <p class="smaill float-right">{{ $nota->created_at}}</p>
                    </div>
                    ...
                    <div class="card-footer">
                        ...
                        <button type="button" class="btn btn-danger btn-sm float-right mr-1" data-toggle="modal" data-target="#modalDelete-{{$nota->id}}">
